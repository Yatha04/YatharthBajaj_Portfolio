        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            project.id === 'cooking-something-cool' ? (
              <div
                key={project.id}
                className="bg-white/80 dark:bg-gray-900/80 rounded-xl border border-gray-200 dark:border-gray-700 shadow-md p-6 flex items-center justify-center min-h-[220px] h-full text-center"
              ...
              <div
                key={project.id}
                className="bg-white/80 dark:bg-gray-900/80 rounded-xl border border-gray-200 dark:border-gray-700 shadow-md hover:shadow-lg transition-all duration-300 p-6 flex flex-col justify-between min-h-[220px]"
              >
                <div>
                  ...
                  <ul className="text-gray-700 dark:text-gray-300 text-sm mb-4 list-disc pl-5">
